...
app.get('', (_, res) => {
  res.send('Hello World'); // Envía una respuesta con el texto 'Hello World' cuando se accede a la raíz
});
...
// Se supone que desde un navegador podremos hacer: http://localhost:3000/notes o http://localhost:3000/info